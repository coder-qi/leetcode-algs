...
public class WordLadderII {
    ...
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        wordMap = new HashMap<>(wordList.size());
        ...
        Set<Integer>[] pathTo = new Set[nodeNum];
        ...
        if (pathTo[beginId] != null) {
            List<String> list = new ArrayList<>();
            list.add(wordMap.get(beginId));
            dfs(beginId, false, pathTo, result, list);
        }

        return result;
    }

    private void dfs(int id, boolean add, Set<Integer>[] pathTo, List<List<String>> result, List<String> list) {
        if (pathTo[id] == null) {
        ...
        for (int x : pathTo[id]) {
            if (add) {
                list.add(wordMap.get(x));
            }
            dfs(x, !add, pathTo, result, list);
            if (add) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new WordLadderII().findLadders("hot", "dog",
            Arrays.asList("hot","dog")));
        System.out.println(new WordLadderII().findLadders("hot", "dog",
            Arrays.asList("hot","dog","dot")));
        System.out.println(new WordLadderII().findLadders("qa", "sq",
